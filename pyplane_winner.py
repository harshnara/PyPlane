"""
Run this file after training and gettting winner pickle object
"""
...
def run_game(winner,config):
    ...
    while running:
        ...
        output = network.activate(player.get_data(enemies))
        ...
        text = generation_font.render("Best score : " + str(round(player.score)), True, BLACK)
...
if __name__ == '__main__':
    ...
    try:
        ...
        print("Please first train using pygame_neat.py and run this file with saved pickle object")
